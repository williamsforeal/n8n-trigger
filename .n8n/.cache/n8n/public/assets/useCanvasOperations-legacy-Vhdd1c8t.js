;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-AVmTL3e2.js", "./truncate-legacy-CZearagB.js", "./useTelemetry-legacy-C2r_IaLn.js", "./useToast-legacy-DS55Efom.js", "./constants-legacy-m0UO56vx.js", "./_baseOrderBy-legacy-ClUBicR6.js", "./useExternalHooks-legacy-L5tpLZMC.js", "./templates.store-legacy-D3pKJOJk.js", "./focusPanel.store-legacy-CVDt1vhK.js", "./executions.store-legacy-s1tWRu-C.js", "./usePinnedData-legacy-D_YRi4Yw.js", "./nodeCreator.store-legacy-DXoY6zG6.js", "./useClipboard-legacy-D8io23OD.js", "./folders.store-legacy-DrvaTGw1.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, shallowRef, useI18n, useLocalStorage, useRoute, createEventBus, useRouter, AddNodeCommand, useProjectsStore, AddConnectionCommand, useUIStore, ReplaceNodeParametersCommand, useCanvasStore, useSettingsStore, useCredentialsStore, RemoveConnectionCommand, RemoveNodeCommand, RenameNodeCommand, v4_default, getNodesGroupSize, injectWorkflowState, CanvasConnectionMode, tryToParseNumber, useHistoryStore, useDataSchema, useTagsStore, useNDVStore, useNodeTypesStore, getNewNodePosition, isPresent, DEFAULT_VIEWPORT_BOUNDARIES, GRID_SIZE, generateOffsets, usePostHog, MoveNodeCommand, CONFIGURATION_NODE_SIZE, useWorkflowHelpers, useWorkflowsStore, PUSH_NODES_OFFSET, isChatNode, CONFIGURABLE_NODE_SIZE, useTelemetry, getExecutionErrorToastConfiguration, DEFAULT_NODE_SIZE, isValidNodeConnectionType, CanvasNodeRenderType, useNodeHelpers, useToast, CANVAS_ZOOMED_VIEW_EXPERIMENT, require__baseUniq, LOCAL_STORAGE_LOGS_SYNC_SELECTION, deepCopy, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, VIEWS, NodeConnectionTypes, isCommunityPackageName, MCP_TRIGGER_NODE_TYPE, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, generateNodesGraph, getSubworkflowId, FORM_TRIGGER_NODE_TYPE, getConnectionTypes, UPDATE_WEBHOOK_ID_NODE_TYPES, LOCAL_STORAGE_LOGS_PANEL_OPEN, getNodeOutputs, EnterpriseEditionFeature, getNodeParameters, NDV_IN_FOCUS_PANEL_EXPERIMENT, getNodeInputs, STICKY_NODE_TYPE, WEBHOOK_NODE_TYPE, require_cloneDeep, defineStore, useRootStore, useExternalHooks, useTemplatesStore, useFocusPanelStore, useExecutionsStore, usePinnedData, mapCanvasConnectionToLegacyConnection, parseCanvasConnectionHandleString, mapLegacyConnectionToCanvasConnection, createCanvasConnectionHandleString, mapLegacyConnectionsToCanvasConnections, useNodeCreatorStore, useClipboard, useFoldersStore, chatEventBus, LOCAL_STORAGE_PANEL_HEIGHT, LOCAL_STORAGE_PANEL_WIDTH, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH, LOGS_PANEL_STATE, LOG_DETAILS_PANEL_STATE, useLogsStore, require_uniq, useExperimentalNdvStore, canvasEventBus, import_cloneDeep, import_uniq;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        CANVAS_ZOOMED_VIEW_EXPERIMENT = _constantsLegacy00RJs.$s;
        require__baseUniq = _constantsLegacy00RJs.Ai;
        LOCAL_STORAGE_LOGS_SYNC_SELECTION = _constantsLegacy00RJs.As;
        deepCopy = _constantsLegacy00RJs.Da;
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = _constantsLegacy00RJs.Ds;
        ...
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE = _constantsLegacy00RJs.Os;
        ...
        getConnectionTypes = _constantsLegacy00RJs.ea;
        UPDATE_WEBHOOK_ID_NODE_TYPES = _constantsLegacy00RJs.gr;
        LOCAL_STORAGE_LOGS_PANEL_OPEN = _constantsLegacy00RJs.ks;
        ...
        NDV_IN_FOCUS_PANEL_EXPERIMENT = _constantsLegacy00RJs.rc;
        ...
        require_cloneDeep = _constantsLegacy00RJs.xi;
