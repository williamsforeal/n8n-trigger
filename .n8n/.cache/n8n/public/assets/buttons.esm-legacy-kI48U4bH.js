...
(function () {
  System.register([], function (_export, _context) {
    ...
    var document, Math, HTMLElement, XMLHttpRequest, forEach, createElementInDocument, createElement, dispatchOnce, hasOwnProperty, toLowerCase, iframeURL, domain, apiBaseURL, useXHR, useShadowDOM, onEvent, offEvent, onceEvent, onceReadyStateChange, parseOptions, buttonsCssText, light, lightHighContrast, dark, darkDimmed, darkHighContrast, stringify, parse, widgetColorSchemes, getColorSchemeMediaQuery, getColorScheme, data, octicon, queues, fetch, render$1, devicePixelRatio, ceilPixel, get, set, render;
    return {
      setters: [],
      execute: function () {
        ...
        */
        ...
        createElementInDocument = function (document$1) {
          return function (tag, props, children) {
            var el = document$1.createElement(tag);
            if (props != null) for (var prop in props) {
              var val = props[prop];
              if (val != null) if (el[prop] != null) el[prop] = val;else el.setAttribute(prop, val);
            }
        ...
        createElement = createElementInDocument(document);
        ...
        iframeURL = "https://unpkg.com/github-buttons@2.29.1/dist/buttons.html";
        domain = "github.com";
        ...
        onEvent = function (target, eventName, func) {
          ...
          if (target.addEventListener) target.addEventListener(eventName, func, false);else target.attachEvent("on" + eventName, func);
        };
        offEvent = function (target, eventName, func) {
          /* istanbul ignore else: IE lt 9 */
          if (target.removeEventListener) target.removeEventListener(eventName, func, false);else target.detachEvent("on" + eventName, func);
        };
        ...
        onceReadyStateChange = function (target, regex, func) {
        ...
        stringify = function (obj, sep, eq, encodeURIComponent) {
          if (sep == null) sep = "&";
          if (eq == null) eq = "=";
        ...
        render$1 = function (root, options, func) {
          var createElement$1 = createElementInDocument(root.ownerDocument);
          var style = root.appendChild(createElement$1("style", {
            type: "text/css"
          }));
          var cssText = buttonsCssText + getColorScheme(options["data-color-scheme"]);
          /* istanbul ignore if: IE lt 9 */
          if (style.styleSheet) style.styleSheet.cssText = cssText;else style.appendChild(root.ownerDocument.createTextNode(cssText));
          ...
          var widget = root.appendChild(createElement$1("div", {
        ...
        _export("render", render = function (options, func) {
