    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        require___vite_browser_external = _emptyLegacy00vJs.S;
        ...
        require_path_browserify = _emptyLegacy00vJs.x;
      }],
      execute: function () {
          ...
          "../../../node_modules/.pnpm/object-inspect@1.13.4/node_modules/object-inspect/index.js": (exports, module) => {
            ...
            function arrObjKeys(obj, inspect$4) {
              ...
              for (var key in obj) {
                ...
                if (hasShammedSymbols && symMap["$" + key] instanceof Symbol) continue;else if ($test.call(/[^\w$]/, key)) xs.push(inspect$4(key, obj) + ": " + inspect$4(obj[key], obj));else xs.push(key + ": " + inspect$4(obj[key], obj));
              }
        ...
        require_side_channel_list = /* @__PURE__ */__commonJS({
        ...
        require_side_channel_map = /* @__PURE__ */__commonJS({
        ...
        require_side_channel_weakmap = /* @__PURE__ */__commonJS({
        ...
        //#region ../../../node_modules/.pnpm/qs@6.14.1/node_modules/qs/lib/formats.js
        ...
        //#region ../../../node_modules/.pnpm/qs@6.14.1/node_modules/qs/lib/utils.js
        require_utils = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/qs@6.14.1/node_modules/qs/lib/utils.js": (exports, module) => {
            ...
            var combine = function combine$1(a, b, arrayLimit, plainObjects) {
              if (isOverflow(a)) {
        ...
        //#region ../../../node_modules/.pnpm/qs@6.14.1/node_modules/qs/lib/stringify.js
        require_stringify = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/qs@6.14.1/node_modules/qs/lib/stringify.js": (exports, module) => {
            ...
            var normalizeStringifyOptions = function normalizeStringifyOptions$1(opts) {
              ...
              var arrayFormat;
              if (opts.arrayFormat in arrayPrefixGenerators) arrayFormat = opts.arrayFormat;else if ("indices" in opts) arrayFormat = opts.indices ? "indices" : "repeat";else arrayFormat = defaults$1.arrayFormat;
        ...
        //#region ../../../node_modules/.pnpm/qs@6.14.1/node_modules/qs/lib/parse.js
            ...
            var parseValues = function parseQueryStringValues(str, options) {
              ...
              for (i = 0; i < parts.length; ++i) {
                ...
                if (key !== null) {
                  ...
                  if (existing && options.duplicates === "combine") obj[key] = utils.combine(obj[key], val, options.arrayLimit, options.plainObjects);else if (!existing || options.duplicates === "last") obj[key] = val;
                }
              }
              return obj;
            };
            var parseObject = function (chain, val, options, valuesParsed) {
              ...
              for (var i = chain.length - 1; i >= 0; --i) {
                ...
                if (root === "[]" && options.parseArrays) {
                  if (utils.isOverflow(leaf)) obj = leaf;else obj = options.allowEmptyArrays && (leaf === "" || options.strictNullHandling && leaf === null) ? [] : utils.combine([], leaf, options.arrayLimit, options.plainObjects);
                } else {
        ...
        //#region ../../../node_modules/.pnpm/qs@6.14.1/node_modules/qs/lib/index.js
