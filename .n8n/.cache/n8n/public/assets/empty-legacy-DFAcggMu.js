      ...
      execute: function () {
        _export("C", init_dist$1 = __esm({
          "../../../node_modules/.pnpm/vite-plugin-node-polyfills@0.24.0_rolldown-vite@7.1.16_@types+node@20.19.21_esbuild@0.2_86160ce2579410c2574f22fd74619205/node_modules/vite-plugin-node-polyfills/shims/process/dist/index.js": () => {
            ...
            _export("w", process$1 = /* @__PURE__ */getDefaultExportFromCjs(browserExports));
          }
        })); //#endregion
        //#region __vite-browser-external
        _export("S", require___vite_browser_external = /* @__PURE__ */__commonJS({
        ...
        _export("x", require_path_browserify = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/path-browserify@1.0.1/node_modules/path-browserify/index.js": (exports, module) => {
            ...
            function normalizeStringPosix(path, allowAboveRoot) {
              ...
              for (var i$1 = 0; i$1 <= path.length; ++i$1) {
                if (i$1 < path.length) code$1 = path.charCodeAt(i$1);else if (code$1 === 47) break;else code$1 = 47;
                if (code$1 === 47) {
                  if (lastSlash === i$1 - 1 || dots === 1) {} else if (lastSlash !== i$1 - 1 && dots === 2) {
                    ...
                    if (res.length > 0) res += "/" + path.slice(lastSlash + 1, i$1);else res = path.slice(lastSlash + 1, i$1);
                    lastSegmentLength = i$1 - lastSlash - 1;
                  }
                  lastSlash = i$1;
                  dots = 0;
                } else if (code$1 === 46 && dots !== -1) ++dots;else dots = -1;
              }
              return res;
            }
            ...
            var posix = {
              resolve: function resolve() {
                ...
                for (var i$1 = arguments.length - 1; i$1 >= -1 && !resolvedAbsolute; i$1--) {
                  var path;
                  if (i$1 >= 0) path = arguments[i$1];else {
              ...
              relative: function relative(from, to) {
                ...
                for (; i$1 <= length; ++i$1) {
                  if (i$1 === length) {
                    if (toLen > length) {
                      if (to.charCodeAt(toStart + i$1) === 47) return to.slice(toStart + i$1 + 1);else if (i$1 === 0) return to.slice(toStart + i$1);
                    } else if (fromLen > length) {
                      if (from.charCodeAt(fromStart + i$1) === 47) lastCommonSep = i$1;else if (i$1 === 0) lastCommonSep = 0;
                    }
                    break;
                  }
                  var fromCode = from.charCodeAt(fromStart + i$1);
                  if (fromCode !== to.charCodeAt(toStart + i$1)) break;else if (fromCode === 47) lastCommonSep = i$1;
                }
                var out = "";
                for (i$1 = fromStart + lastCommonSep + 1; i$1 <= fromEnd; ++i$1) if (i$1 === fromEnd || from.charCodeAt(i$1) === 47) if (out.length === 0) out += "..";else out += "/..";
              ...
              extname: function extname(path) {
                ...
                for (var i$1 = path.length - 1; i$1 >= 0; --i$1) {
                  ...
                  if (code$1 === 46) {
                    if (startDot === -1) startDot = i$1;else if (preDotState !== 1) preDotState = 1;
