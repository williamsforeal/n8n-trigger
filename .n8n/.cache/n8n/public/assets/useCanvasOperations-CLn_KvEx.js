...
import { v as useRoute, x as createEventBus, y as useRouter } from "./truncate-CPQnASOt.js";
import { Dr as AddNodeCommand, En as useProjectsStore, Er as AddConnectionCommand, Fi as useUIStore, Fr as ReplaceNodeParametersCommand, Gn as useCanvasStore, Ho as useSettingsStore, Ht as useCredentialsStore, Mr as RemoveConnectionCommand, Nr as RemoveNodeCommand, Pr as RenameNodeCommand, Ro as v4_default, S as getNodesGroupSize, Sn as injectWorkflowState, Sr as CanvasConnectionMode, Ti as tryToParseNumber, Tr as useHistoryStore, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, at as useNodeTypesStore, b as getNewNodePosition, bi as isPresent, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, h as generateOffsets, i as usePostHog, jr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, q as isChatNode, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, tt as getExecutionErrorToastConfiguration, u as DEFAULT_NODE_SIZE, vr as isValidNodeConnectionType, wr as CanvasNodeRenderType, xn as useNodeHelpers } from "./useTelemetry-uuuKTA_V.js";
import { t as useToast } from "./useToast-BbkTJzz2.js";
import { $s as CANVAS_ZOOMED_VIEW_EXPERIMENT, Ai as require__baseUniq, As as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Da as deepCopy, Ds as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Io as VIEWS, Ka as NodeConnectionTypes, Oa as isCommunityPackageName, On as MCP_TRIGGER_NODE_TYPE, Os as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Zi as generateNodesGraph, ca as getSubworkflowId, dn as FORM_TRIGGER_NODE_TYPE, ea as getConnectionTypes, gr as UPDATE_WEBHOOK_ID_NODE_TYPES, ks as LOCAL_STORAGE_LOGS_PANEL_OPEN, na as getNodeOutputs, pc as EnterpriseEditionFeature, ra as getNodeParameters, rc as NDV_IN_FOCUS_PANEL_EXPERIMENT, ta as getNodeInputs, ur as STICKY_NODE_TYPE, vr as WEBHOOK_NODE_TYPE, xi as require_cloneDeep } from "./constants-Cr7jJokO.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-DNqJcaXz.js";
