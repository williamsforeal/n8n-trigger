;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-AVmTL3e2.js", "./truncate-legacy-CZearagB.js", "./useTelemetry-legacy-C2r_IaLn.js", "./constants-legacy-m0UO56vx.js", "./merge-legacy-DPPgEKrt.js", "./_baseOrderBy-legacy-ClUBicR6.js", "./useExternalHooks-legacy-L5tpLZMC.js", "./templates.store-legacy-D3pKJOJk.js", "./nodeIcon-legacy-BmYs1Ef9.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, useI18n, require__arrayMap, require_get, require_toString, useRoute, useRouter, getThemedValue, getSampleWorkflowByTemplateId, require__createCompounder, sortNodeCreateElements, useProjectsStore, SampleTemplates, useUIStore, useCanvasStore, useSettingsStore, updateCurrentUserSettings, isPrebuiltAgentTemplateId, isTutorialTemplateId, getPrebuiltAgents, v4_default, require_upperFirst, CanvasConnectionMode, transformNodeType, isAINode, useNDVStore, useNodeTypesStore, isVueFlowConnection, getAiTemplatesCallout, isValidCanvasConnectionMode, groupItemsInSections, usePostHog, getTutorialTemplates, getRagStarterWorkflowJson, finalizeItems, getPreBuiltAgentsCalloutWithDivider, useUsersStore, useWorkflowsStore, STORES, useEvaluationStore, useTelemetry, flattenCreateElements, isValidNodeConnectionType, subcategorizeItems, searchNodes, prepareCommunityNodeDetailsViewStack, AI_CATEGORY_LANGUAGE_MODELS, EDIT_IMAGE_NODE_TYPE, TRANSFORM_DATA_SUBCATEGORY, CHAT_TRIGGER_NODE_TYPE, LIMIT_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, MARKDOWN_NODE_TYPE, REGULAR_NODE_CREATOR_VIEW, MANUAL_TRIGGER_NODE_TYPE, CODE_NODE_TYPE, CUSTOM_API_CALL_KEY, VIEWS, AI_TRANSFORM_NODE_TYPE$1, CRYPTO_NODE_TYPE, NodeConnectionTypes, require__arrayIncludes, AGGREGATE_NODE_TYPE, isCommunityPackageName, AI_CODE_NODE_TYPE, AI_CATEGORY_EMBEDDING, AI_TRANSFORM_NODE_TYPE, SCHEDULE_TRIGGER_NODE_TYPE, require__SetCache, HUMAN_IN_THE_LOOP_CATEGORY, COMPRESSION_NODE_TYPE, CONVERT_TO_FILE_NODE_TYPE, AI_CATEGORY_CHAINS, RSS_READ_NODE_TYPE, DATA_TABLE_NODE_TYPE, AI_CATEGORY_AGENTS, REMOVE_DUPLICATES_NODE_TYPE, AI_CATEGORY_DOCUMENT_LOADERS, DATETIME_NODE_TYPE, IF_NODE_TYPE, CORE_NODES_CATEGORY, PRE_BUILT_AGENTS_MODAL_KEY, AI_CATEGORY_ROOT_NODES, HELPERS_SUBCATEGORY, require__baseFlatten, EXTRACT_FROM_FILE_NODE_TYPE, AI_CATEGORY_VECTOR_STORES, FORM_TRIGGER_NODE_TYPE, SUMMARIZE_NODE_TYPE, AI_NODE_CREATOR_VIEW, AI_CATEGORY_MCP_NODES, AI_OTHERS_NODE_CREATOR_VIEW, HTTP_REQUEST_NODE_TYPE, AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, AI_CATEGORY_RETRIEVERS, require__arrayIncludesWith, TRIGGER_NODE_CREATOR_VIEW, MERGE_NODE_TYPE, TEMPLATE_CATEGORY_AI, FILTER_NODE_TYPE, AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, HTML_NODE_TYPE, AI_UNCATEGORIZED_CATEGORY, EMAIL_SEND_NODE_TYPE, PRE_BUILT_AGENTS_EXPERIMENT, SPLIT_IN_BATCHES_NODE_TYPE, AI_CATEGORY_TEXT_SPLITTERS, AI_SUBCATEGORY, NODE_MIN_INPUT_ITEMS_COUNT, EVALUATION_TRIGGER_NODE_TYPE, AI_CATEGORY_OUTPUTPARSER, EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, SPLIT_OUT_NODE_TYPE, AI_CATEGORY_TOOLS, getNodeInputs, EMAIL_IMAP_NODE_TYPE, SET_NODE_TYPE, AI_CATEGORY_MEMORY, WEBHOOK_NODE_TYPE, DEFAULT_SUBCATEGORY, XML_NODE_TYPE, OTHER_TRIGGER_NODES_SUBCATEGORY, require__cacheHas, HITL_SUBCATEGORY, FLOWS_CONTROL_SUBCATEGORY, require__baseUnary, require__baseRest, require_isArrayLikeObject, defineStore, useRootStore, useExternalHooks, useTemplatesStore, getNodeIconSource, require__baseDifference, require_difference, require_capitalize, require_camelCase, import_camelCase, KEYBOARD_ID_ATTR, WATCHED_KEYS, useKeyboardNavigation, __virtual_node_popularity_data_default, import_difference, nodePopularityMap, useViewStacks, import_get, useNodeCreatorStore;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        require__arrayIncludes = _constantsLegacy00RJs.Mi;
        ...
        require__SetCache = _constantsLegacy00RJs.So;
        ...
        PRE_BUILT_AGENTS_MODAL_KEY = _constantsLegacy00RJs.as;
        AI_CATEGORY_ROOT_NODES = _constantsLegacy00RJs.at;
        HELPERS_SUBCATEGORY = _constantsLegacy00RJs.bt;
        require__baseFlatten = _constantsLegacy00RJs.ci;
        ...
        require__arrayIncludesWith = _constantsLegacy00RJs.ji;
        ...
        PRE_BUILT_AGENTS_EXPERIMENT = _constantsLegacy00RJs.oc;
        ...
        XML_NODE_TYPE = _constantsLegacy00RJs.wr;
        OTHER_TRIGGER_NODES_SUBCATEGORY = _constantsLegacy00RJs.wt;
        require__cacheHas = _constantsLegacy00RJs.xo;
      ...
      execute: function () {
        ...
        _export("y", require_capitalize = /* @__PURE__ */__commonJS({
          "../../../node_modules/.pnpm/lodash@4.17.23/node_modules/lodash/capitalize.js": (exports, module) => {
